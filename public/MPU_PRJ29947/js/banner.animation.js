...
Banner.prototype.animate = function () {
  ...
  .add(stroke1, 0.1).add(stroke2, 0).add(stroke3, 0.9).add(stroke4, 0.8).add(copyTl, 0.2).add(copy1, 2).add(imageTl, 2.1).add(imgScale, 2.1).add(second, 3.9).add(stroke2a, 4.7).add(stroke2b, 5).add(stroke2c, 5.9).add(stroke2d, 5.8).add(copy2Tl, 5.2).add(moveCopy2, 6.7).add(finalFrame, 6.7).add(outline, 6.9).call(function () {
    if (loops === maxLoops) {
